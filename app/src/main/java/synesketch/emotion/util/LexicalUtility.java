...
public class LexicalUtility {
	...
	private String fileNameLexicon = "/assets/data/lex/synesketch_lexicon.txt";
	private String fileNameEmoticons = "/assets/data/lex/synesketch_lexicon_emoticons.txt";
	private String fileNameProperties = "/assets/data/lex/keywords.xml";
