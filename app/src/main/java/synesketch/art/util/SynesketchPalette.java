...
/**
 * Representation of a six-part color data.palette used for Synesketch sketches. Each
 * part of the data.palette represents colors -- defined by it's coded hex number --
 ...
 * standard data.palette (data/data.palette/standard.xml), based on some phycology &
 * visual design theories, but everyone can write it's own data.palette by writing
 * one's own XML document similar to data/data.palette/standard.xml.
 * 
...
public class SynesketchPalette {
	 ...
	 * from a XML file defined by data.palette's name.
	 * 
	 * @param paletteName
	 *            {@link String} name of the six-part data.palette -- XML file with
	...
	/**
	 * Getter for the data.palette for the emotion of anger.
	 * 
	 * @return array of integers representing the data.palette for the emotion of anger
	 */
	...
	/**
	 * Getter for the data.palette for the emotion of disgust.
	 * 
	 * @return array of integers representing the data.palette for the emotion of disgust
	 */
	...
	/**
	 * Getter for the data.palette for the emotion of fear.
	 * 
	 * @return array of integers representing the data.palette for the emotion of fear
	 */
	...
	/**
	 * Getter for the data.palette for the emotion of happiness.
	 * 
	 * @return array of integers representing the data.palette for the emotion of happiness
	 */
	...
	/**
	 * Getter for the data.palette for the emotion of sadness.
	 * 
	 * @return array of integers representing the data.palette for the emotion of sadness
	 */
	...
	/**
	 * Getter for the data.palette for the emotion of surprise
	 * 
	 * @return array of integers representing the data.palette for the emotion of surprise.
	 */
	...
	/**
	 * Returns a random color from the hapiness data.palette.
	 * 
	...
	/**
	 * Returns a random color from the sadness data.palette.
	 * 
	 * @return integer which represents the color
	 */
	...
	/**
	 * Returns a random color from the anger data.palette.
	 * 
	 * @return integer which represents the color
	 */
	...
	/**
	 * Returns a random color from the fear data.palette.
	 * 
	 * @return integer which represents the color
	 */
	...
	/**
	 * Returns a random color from the disgust data.palette.
	 * 
	 * @return integer which represents the color
	 */
	...
	/**
	 * Returns a random color from the surprise data.palette.
	 * 
	 * @return integer which represents the color
	 */
